...
推荐优先使用 Docker 部署；如果部署环境不方便运行容器，可以根据 [Release](https://github.com/jshir700/SubConverter-Extended/releases/latest) 中的安装包类型选择便携包或 OpenWrt APK。
...
| 类型 | 文件 / 镜像 | 适用场景 |
| :--- | :--- | :--- |
| Docker 镜像 | `jshir700/subconverter-extended`、`ghcr.io/jshir700/subconverter-extended` | 服务器、NAS、软路由容器环境 |
...
wget -O base/pref.toml \
  https://gcore.jsdelivr.net/gh/jshir700/SubConverter-Extended@master/base/pref.example.toml
...
wget -O docker-compose.yml \
  https://gcore.jsdelivr.net/gh/jshir700/SubConverter-Extended@master/docker-compose.yml
...
curl -fLO "https://github.com/jshir700/SubConverter-Extended/releases/download/${VERSION}/SubConverter-Extended-${VERSION}-linux-${ARCH}.tar.gz"
curl -fLO "https://github.com/jshir700/SubConverter-Extended/releases/download/${VERSION}/SHA256SUMS"
...
1. 从 [Release](https://github.com/jshir700/SubConverter-Extended/releases/latest) 下载 `windows-amd64.zip`。
...
wget -O "$PKG" \
  "https://github.com/jshir700/SubConverter-Extended/releases/download/${VERSION}/SubConverter-Extended-${VERSION}-openwrt-${ARCH}.apk"
...
<a href="https://www.star-history.com/#jshir700/SubConverter-Extended&Date">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=jshir700/SubConverter-Extended&type=Date&theme=dark" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=jshir700/SubConverter-Extended&type=Date" />
   <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=jshir700/SubConverter-Extended&type=Date" />
 </picture>
</a>
