...
std::shared_future<std::string> fetchFileAsync(const std::string &path, const std::string &proxy, int cache_ttl, bool find_local = true, bool async = false, const std::string &user_agent = "", FetchContext context = FetchContext::TrustedConfig);
std::string fetchFile(const std::string &path, const std::string &proxy, int cache_ttl, bool find_local = true, FetchContext context = FetchContext::TrustedConfig);
